    ...
    try {
        ...
        setInterval(() => {
            ...
            switch (time2check) {
                ...
                case '10:30': case '11:30': case '14:30': case "15:25": case '16:34': case '18:45': case '20:35': case '23:45':
                    //extract tomorrow 1x2
                    call_scheduled_checker_fn.extractMyBetsToday('soccer-prediction/tomorrow/', trhKesho)
